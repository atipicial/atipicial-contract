...
This guide explains the structure of ATC contract manifests and how to customize them when needed.

## Manifest Structure

A ATC contract manifest is a JSON file that contains metadata about the contract. Here's an example of the structure:
...
```json
{
  ...
  "trusts": [],
  "extra": {
    "Description": "This is my AEP-17 token contract",
...
- **supportedstandards**: List of AEP standards implemented (e.g., ["AEP-17"], ["AEP-11"])
...
ATC contracts use these standard parameter types:
...
3. Ensure the manifest still adheres to the ATC blockchain requirements
...
By following these guidelines, you'll create well-documented and secure ATC contract manifests that provide clear interfaces for users and other contracts.
