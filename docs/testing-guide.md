...
This guide provides comprehensive strategies and patterns for testing Atipicial smart contracts written with the **Atipicial Rust Smart Contract Framework**.
...
- **Mock Environment** - Simulated Atipicial runtime for testing
...
For contracts that don't heavily rely on blockchain-specific features, you can create mock implementations of Atipicial's environment.
...
### 2. Integration Testing with Atipicial-Express

For full integration testing, you can use [Atipicial-Express](https://github.com/atipicial-project/atipicial-express) to create a private Atipicial blockchain for testing.

1. Deploy your contract to Atipicial-Express
2. Interact with it using Atipicial SDK
...
## Testing AEP-17 Token Contracts

Here's a specific example for testing a AEP-17 token:
...
mod tests {
    ...
    // More complex tests would require mocking the Atipicial environment
}
```
...
## Advanced Testing with Atipicial Blockchain Emulation

For advanced testing, consider:

1. Creating a mock Atipicial VM implementation
2. Using [atipicial-go](https://github.com/atipicial/atipicial-go) for testing in a simulated environment
...
4. Use Atipicial's debug tools with compiled contracts
...
mod tests {
    use super::*;
    use atipicial_contract::testing::*;
...
1. **Build Contract** - `make` to generate AEF and manifest
2. **Deploy to Testnet** - Use Atipicial-CLI or Atipicial-Express
3. **Test with SDK** - Use Atipicial SDK for integration tests
