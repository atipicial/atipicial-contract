...
pub fn expand_program(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let expanded = quote! {
        ...
        #mod_vis mod #mod_name {
            ...
            // Entry point for Atipicial contract
            #[no_mangle]
    ...
    let expanded = quote! {
        ...
        impl #struct_name {
            ...
            pub fn serialize(&self) -> atipicial_contract::types::Bytes {
                ...
                atipicial_contract::types::Bytes::from(result)
            }
...
pub fn expand_declare_id(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let expanded = quote! {
        ...
        pub fn id() -> atipicial_contract::types::H160 {
            atipicial_contract::types::H160::zero()
        }
    };
...
pub fn expand_error_code(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let expanded = quote! {
        ...
        impl From<#enum_name> for atipicial_contract::error::ContractError {
            fn from(err: #enum_name) -> Self {
                atipicial_contract::error::ContractError::Custom(err.code(), alloc::string::String::from(err.message()))
            }
        }
    };
