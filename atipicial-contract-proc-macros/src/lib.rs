...
/// ```rust
/// use atipicial_contract as atipicial;
///
/// struct MyContract; // It must be a empty struct without `{}` or `()`
///
/// #[atipicial::contract] // To indicate that it implements as a atipicial smart contract
/// impl Aep17Token for MyContract {
///     fn symbol() -> String {
...
/// }
///
/// // ... other aep17 methods that has default implementation
/// ```
...
/// It converts a rust struct to a atipicial contract struct.
/// ```rust
/// use atipicial_contract as atipicial;
///
/// #[atipicial::structs]
...
///
/// This is the recommended pattern for Atipicial smart contracts, providing type-safe
/// method definitions with automatic export generation. This approach combines
/// Solana-style ergonomics with Atipicial blockchain features.
///
/// # Example
///
/// ```
...
///
/// ```
/// #[contract_author("Atipicial Contract Team")]
/// pub struct TokenContract;
/// ```
#[proc_macro_attribute]
...
/// Legacy Solana-style program macro for Atipicial smart contracts
/// 
...
///
/// ```
/// declare_id!("AtipicialContractAddress123...");
///
/// #[program]
/// pub mod my_atipicial_program {
///     use super::*;
///
...
/// Derive macro for Solana-style account validation in Atipicial
///
/// # Example
///
/// ```
...
/// Declares the program ID for a Atipicial smart contract
///
/// # Example
///
/// ```
