...
// Simple AEP-24 Royalty NFT Implementation
#[contract]
pub struct AEP24RoyaltyNFT {
...
impl AEP24RoyaltyNFT {
    ...
    fn post_transfer(&self, from: H160, to: H160, amount: Int256, token_id: ByteString, data: Any) {
        // Try to call onAEP11Payment on the 'to' contract
