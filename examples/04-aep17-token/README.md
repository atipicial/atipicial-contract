...
A complete, production-ready implementation of the AEP-17 fungible token standard for Atipicial. This contract demonstrates advanced token mechanics, security patterns, and administrative controls suitable for real-world deployment.

## 🎯 **Key Features**

### **Core AEP-17 Compliance**
...
# Deploy using atipicial-cli
atipicial> deploy path/to/contract.aef path/to/manifest.json
```

### **3. Initialize Token**
```bash
# Call deploy method
atipicial> invokefunction <contract_hash> deploy <owner> <symbol> <decimals> <initial_supply> <max_supply>
```
...
- **[05-aep11-nft](../05-aep11-nft/)** - Non-fungible token implementation
- **[06-aep24-royalty-nft](../06-aep24-royalty-nft/)** - NFT with royalty features
