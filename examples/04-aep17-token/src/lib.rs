//! # AEP-17 Fungible Token Contract
//!
//! A complete implementation of the AEP-17 fungible token standard for Atipicial.
...
use atipicial_contract::types::{IntoByteString, FromByteString, builtin::IntoAny};

/// AEP-17 compliant fungible token contract
#[contract_author("Atipicial Rust Framework", "dev@atipicial.com")]
#[contract_version("1.0.0")]
#[contract_standards("AEP-17")]
#[contract_permission("*", "*")]
#[contract_meta("description", "Production-ready AEP-17 fungible token")]
#[contract_meta("website", "https://github.com/Atipicial-Network/atipicial-contract-rs")]
...
impl Aep17Token {
    ...
    /// Get token symbol (AEP-17 required)
    #[method]
    #[safe]
    ...
    /// Get token decimals (AEP-17 required)
    #[method]
    #[safe]
    ...
    /// Get total token supply (AEP-17 required)
    #[method]
    #[safe]
    ...
    /// Get balance of an account (AEP-17 required)
    #[method]
    #[safe]
    ...
    /// Transfer tokens (AEP-17 required)
    #[method]
    ...
    fn on_payment_callback(&self, from: H160, amount: Int256, data: Any) {
        // This would call onAEP17Payment on the recipient contract if it's a contract
