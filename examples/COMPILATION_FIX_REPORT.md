...
# Atipicial Smart Contract Examples - Compilation Fix Report
...
**Root Cause**: Attempt to use Solana-specific patterns that don't exist in Atipicial framework

### ✅ 14-atipicial-features-showcase & 15-atipicial-complete-features (Cargo.toml only)
**Issues Fixed**:
...
1. **04-aep17-token-solana-style** (78 compilation errors)
   - Similar issues to fixed examples but more extensive
   - Requires comprehensive refactoring from Solana to Atipicial patterns

### AEP Standard Implementations  
2. **05-aep11-nft** (13 compilation errors)
3. **06-aep24-royalty-nft** (Similar pattern)
...
11. **14-atipicial-features-showcase** (Cargo.toml fixed, source issues remain)
12. **15-atipicial-complete-features** (Cargo.toml fixed, source issues remain)
...
- Method availability on Atipicial types vs standard types
...
1. Migrate Solana-style examples to proper Atipicial patterns
