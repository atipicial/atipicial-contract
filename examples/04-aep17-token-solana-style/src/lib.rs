...
// AEP-17 Token Implementation - Solana Style (Converted to Atipicial)
pub struct AEP17TokenSolanaStyle {
...
impl AEP17TokenSolanaStyle {
    ...
    fn post_transfer(&self, from: H160, to: H160, amount: Int256, data: Any, call_onpayment: bool) {
        if call_onpayment {
            // Try to call onAEP17Payment on the 'to' contract
