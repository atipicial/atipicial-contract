...
class DeFiDeployer:
    ...
    def deploy_contract(self, wasm_path, name, wallet="defi-deployer"):
        ...
        # Convert WASM to AEF using atipicial-compiler
        aef_path = wasm_path.replace(".wasm", ".aef")
        ...
        manifest = {
            ...
            "groups": [],
            "features": {},
            "supportedstandards": ["AEP-17"] if "token" in name else [],
            "abi": {
                "methods": [],
                "events": []
            },
        ...
        cmd = f"atipicial-express contract deploy {aef_path} {wallet} -i {self.network}"
    ...
    def setup_test_tokens(self):
        ...
        for symbol, name, contract_name in tokens:
            ...
            cmd = f'atipicial-express contract invoke {contract_name} initialize \\
    ...
    def setup_uniswap_pools(self):
        ...
        for token_a, token_b, fee in pairs:
            ...
            cmd = f'''atipicial-express contract invoke uniswap-v2-amm initialize_pool \\
    ...
    def setup_compound_markets(self):
        ...
        for token, collateral_factor, base_rate, multiplier, reserve_factor in markets:
            ...
            cmd = f'''atipicial-express contract invoke compound-lending initialize_market \\
    ...
    def setup_aave_flashloan(self):
        ...
        cmd = f'''atipicial-express contract invoke aave-flashloan initialize_pool \\
    ...
    def provide_initial_liquidity(self):
        ...
        for user in users:
            for token, amount in amounts.items():
                ...
                cmd = f'''atipicial-express contract invoke {self.contracts[token]} mint \\
