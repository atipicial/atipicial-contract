...
impl<'a> SolanaStyleDetector<'a> {
    ...
    pub fn detect(&mut self) -> Result<bool> {
        ...
        for import in &self.module.imports {
            if import.module == "atipicial_contract" {
    ...
    pub fn generate_manifest(&self) -> Result<Manifest> {
        ...
        // Auto-detect AEP standards
        if self.has_aep17_methods() {
            manifest.add_aep17_standard();
        }
        
        if self.has_aep11_methods() {
            manifest.add_aep11_standard();
        }
    ...
    fn is_solana_handler(name: &str) -> bool {
        let common_handlers = [
            ...
            // Additional Atipicial Solana-style patterns
    ...
    fn infer_return_type(&self, name: &str) -> String {
        match name {
            ...
            "owner_of" => "Hash160",
            // Atipicial Solana-style methods
    ...
    /// Check if contract has AEP-17 token methods
    fn has_aep17_methods(&self) -> bool {
    ...
    /// Check if contract has AEP-11 NFT methods
    fn has_aep11_methods(&self) -> bool {
