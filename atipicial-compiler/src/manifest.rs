...
impl Manifest {
    ...
    /// Add AEP-17 standard support
    pub fn add_aep17_standard(&mut self) {
        self.supported_standards.push("AEP-17".to_string());
        
        // Add standard AEP-17 methods if not present
    ...
    /// Add AEP-11 (NFT) standard support
    pub fn add_aep11_standard(&mut self) {
        self.supported_standards.push("AEP-11".to_string());
        
        // Add standard AEP-11 methods
        let standard_methods = vec![
            ("symbol", vec![], "string"),
            ("decimals", vec![], "integer"),
            ("totalSupply", vec![], "integer"),
...
mod tests {
    ...
    #[test]
    fn test_aep17_standard() {
        let mut manifest = Manifest::default();
        manifest.add_aep17_standard();
        
        assert!(manifest.supported_standards.contains(&"AEP-17".to_string()));
