...
use atipicial_compiler::opcodes::OpCode;
use atipicial_compiler::translator::WasmTranslator;
use atipicial_compiler::manifest::Manifest;
...
mod tests {
    ...
    fn test_arithmetic_instructions() -> Result<()> {
        ...
        let aef = translator.translate(&module, &manifest, "test")?;
        let script = aef.script();
        
        // Verify the AEF was generated (basic check)
        ...
        println!("Generated AEF script length: {}", script.len());
    ...
    fn test_comparison_instructions() -> Result<()> {
        ...
        assert!(!script.is_empty());
        println!("Comparison AEF script length: {}", script.len());
    ...
    fn test_control_flow_instructions() -> Result<()> {
        ...
        assert!(!script.is_empty());
        println!("Control flow AEF script length: {}", script.len());
    ...
    fn test_loop_instructions() -> Result<()> {
        ...
        assert!(!script.is_empty());
        println!("Loop AEF script length: {}", script.len());
    ...
    fn test_enhanced_vs_legacy_translation() -> Result<()> {
        ...
        let legacy_aef = legacy_translator.translate(&module, &manifest, "test")?;
        ...
        let enhanced_aef = enhanced_translator.translate(&module, &manifest, "test")?;
        
        // Results should be different
        let legacy_script = legacy_aef.script();
        let enhanced_script = enhanced_aef.script();
