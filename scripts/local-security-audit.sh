...
echo -e "${BLUE}║              Atipicial Framework Security Validation             ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════════╝${NC}"
...
UNSAFE_COUNT=$(find atipicial-contract/src atipicial-compiler/src atipicial-contract-proc-macros/src -name "*.rs" -exec grep -l "unsafe" {} \; 2>/dev/null | wc -l)
if [ "$UNSAFE_COUNT" -eq 0 ]; then
    ...
    find atipicial-contract/src atipicial-compiler/src atipicial-contract-proc-macros/src -name "*.rs" -exec grep -Hn "unsafe" {} \; 2>/dev/null | head -5
fi
