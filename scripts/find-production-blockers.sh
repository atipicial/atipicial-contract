...
check_compilation_errors() {
    ...
    # Check core library
    echo -n "  Checking atipicial-contract... "
    ...
    # Check compiler
    echo -n "  Checking atipicial-compiler... "
    ...
    # Check proc macros
    echo -n "  Checking atipicial-contract-proc-macros... "
...
missing_types=(
    "Crowdfunding"
    "AtipicialFeaturesShowcase" 
    "AEP17TokenSolanaStyle"
    "MultisigWallet"
    "Governance"
    "Staking"
