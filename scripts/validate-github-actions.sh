...
SCRIPT_COUNT=0
for script in scripts/find-production-blockers.sh scripts/final-production-check.sh scripts/validate-atipicial-completeness.sh scripts/validate-reference-implementation.sh scripts/run-all-validations.sh; do
