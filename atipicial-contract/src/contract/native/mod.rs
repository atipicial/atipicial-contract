...
pub use {gas::*, legder::*, atipicial::*, oracle::*, policy::*};

use crate::types::atipicial::Role;
...
impl ContractManagement {
    ...
    pub fn deploy(aef: ByteString, manifest: ByteString) -> Contract {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_contract_management_deploy(aef, manifest) }
    ...
    pub fn update(aef: ByteString, manifest: ByteString) {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_contract_management_update(aef, manifest) }
