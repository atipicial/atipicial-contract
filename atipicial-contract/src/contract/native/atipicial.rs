...
impl Atipicial {
    ...
    pub fn hash() -> H160 {
        ...
        unsafe { env::contract::native_atipicial_contract_hash() }
    ...
    pub fn symbol() -> ByteString {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_symbol() }

        #[cfg(not(target_family = "wasm"))]
        ByteString::new("ATC".as_bytes().to_vec())
    }
    ...
    pub fn decimals() -> u32 {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_decimals() }
    ...
    pub fn total_supply() -> Int256 {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_total_supply() }
    ...
    pub fn balance_of(account: H160) -> Int256 {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_balance_of(account) }
    ...
    pub fn transfer(from: H160, to: H160, amount: Int256) -> bool {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_transfer(from, to, amount) }
    ...
    pub fn get_gas_per_block() -> Int256 {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_get_gas_per_block() }
    ...
    pub fn unclaimed_gas(account: H160, end_block: u32) -> Int256 {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_unclaimed_gas(account, end_block) }
    ...
    pub fn register_candidate(public_key: PublicKey) -> bool {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_register_candidate(public_key) }
    ...
    pub fn unregister_candidate(public_key: PublicKey) -> bool {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_unregister_candidate(public_key) }
    ...
    pub fn vote(account: H160, vote_to: PublicKey) -> bool {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_vote(account, vote_to) }
    ...
    pub fn unvote(account: H160) -> bool {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_unvote(account) }
    ...
    pub fn get_candidates() -> Array<contract::AtipicialCandidate> {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_get_candidates() }
    ...
    pub fn get_committee() -> Array<PublicKey> {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_get_committee() }
    ...
    pub fn get_next_block_validators() -> Array<PublicKey> {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_get_next_block_validators() }
    ...
    pub fn get_account_state(account: H160) -> contract::AtipicialAccountState {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_get_account_state(account) }

        #[cfg(not(target_family = "wasm"))]
        contract::AtipicialAccountState::default() // Mock implementation for non-WASM targets
    }
    ...
    pub fn get_candidate_votes(public_key: PublicKey) -> Int256 {
        #[cfg(target_family = "wasm")]
        unsafe { env::contract::native_atipicial_get_candidate_votes(public_key) }
