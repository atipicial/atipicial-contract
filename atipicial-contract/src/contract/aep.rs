...
/// AEP-24: Royalty Standard for Non-Fungible Tokens
///
...
pub trait Aep26 {
    fn on_aep11_payment(from: H160, amount: Int256, token_id: ByteString);

    // fn on_aep17_payment_with_data(from: H160, amount: Int256, data: Any);
}

pub trait Aep27 {
    fn on_aep17_payment(from: H160, amount: Int256);
