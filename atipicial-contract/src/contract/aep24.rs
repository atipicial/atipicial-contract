...
/// AEP-24 trait for NFT contracts with royalty support
pub trait AEP24 {
...
/// AEP-24 implementation helper
pub struct AEP24Implementation;

impl AEP24Implementation {
    ...
    pub fn process_royalty_payment(
        ...
        let royalty_info = AEP24Implementation::get_royalty(token_id.clone())
            .or_else(|| AEP24Implementation::get_default_royalty())
            .ok_or_else(|| ByteString::from_literal("No royalty info"))?;

        // Calculate royalty amount
        let royalty_amount = AEP24Implementation::calculate_royalty(sale_price, royalty_info.amount);
