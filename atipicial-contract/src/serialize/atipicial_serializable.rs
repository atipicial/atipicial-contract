...
/// Trait for types that can be serialized to and from Atipicial's binary format
...
// Implement AtipicialSerializable for basic types
...
impl AtipicialSerializable for u16 {
    fn to_bytes(&self) -> Bytes {
...
impl AtipicialSerializable for u32 {
    fn to_bytes(&self) -> Bytes {
        Bytes::from_slice(&self.to_le_bytes())
    }
...
impl AtipicialSerializable for u64 {
    fn to_bytes(&self) -> Bytes {
        Bytes::from_slice(&self.to_le_bytes())
    }
...
impl AtipicialSerializable for i32 {
    fn to_bytes(&self) -> Bytes {
        Bytes::from_slice(&self.to_le_bytes())
    }
...
impl AtipicialSerializable for i64 {
    fn to_bytes(&self) -> Bytes {
        Bytes::from_slice(&self.to_le_bytes())
    }
...
impl AtipicialSerializable for bool {
    fn to_bytes(&self) -> Bytes {
...
impl AtipicialSerializable for ByteString {
    fn to_bytes(&self) -> Bytes {
        // Atipicial format: length (varint) + data
...
impl AtipicialSerializable for Int256 {
    fn to_bytes(&self) -> Bytes {
        #[cfg(not(target_family = "wasm"))]
        {
