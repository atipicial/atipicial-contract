...
#[cfg(target_family = "wasm")]
use crate::types::contract::{AtipicialCandidate, AtipicialAccountState};

#[link(wasm_import_module = "atipicial.contract")]
...
extern "C" {
    ...
    pub(crate) fn native_atipicial_contract_hash() -> H160;

    pub(crate) fn native_atipicial_symbol() -> ByteString;

    pub(crate) fn native_atipicial_decimals() -> u32;

    pub(crate) fn native_atipicial_total_supply() -> Int256;

    pub(crate) fn native_atipicial_balance_of(account: H160) -> Int256;

    pub(crate) fn native_atipicial_transfer(from: H160, to: H160, amount: Int256) -> bool;

    pub(crate) fn native_atipicial_get_gas_per_block() -> Int256;

    pub(crate) fn native_atipicial_get_register_price() -> Int256;

    pub(crate) fn native_atipicial_unclaimed_gas(account: H160, util_block_index: u32) -> Int256;

    pub(crate) fn native_atipicial_register_candidate(public_key: PublicKey) -> bool;

    pub(crate) fn native_atipicial_unregister_candidate(public_key: PublicKey) -> bool;

    pub(crate) fn native_atipicial_vote(account: H160, vote_to: PublicKey) -> bool;

    pub(crate) fn native_atipicial_unvote(account: H160) -> bool;

    pub(crate) fn native_atipicial_get_candidate_votes(public_key: PublicKey) -> Int256;

    pub(crate) fn native_atipicial_get_candidates() -> Array<AtipicialCandidate>;

    pub(crate) fn native_atipicial_get_committee() -> Array<PublicKey>;

    pub(crate) fn native_atipicial_get_next_block_validators() -> Array<PublicKey>;

    pub(crate) fn native_atipicial_get_account_state(account: H160) -> AtipicialAccountState;

    // pub(crate) fn native_atipicial_get_all_candidates() -> Placeholder;

    pub(crate) fn native_atipicial_get_committee_address() -> H160;
    ...
    pub(crate) fn native_contract_management_update(aef: ByteString, manifest: ByteString);
