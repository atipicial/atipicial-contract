...
//! Atipicial-specific types for the Atipicial smart contract framework

use crate::types::{PublicKey, Int256};

/// Represents a candidate in the Atipicial network
...
impl AtipicialCandidate {
    /// Creates a new AtipicialCandidate
    pub fn new(public_key: PublicKey, votes: Int256) -> Self {
        Self { public_key, votes }
    }
}

impl Default for AtipicialCandidate {
    fn default() -> Self {
        Self {
...
/// Represents the account state in the Atipicial network
#[derive(Debug, Clone, PartialEq)]
pub struct AtipicialAccountState {
    /// The balance of ATC tokens
    pub balance: Int256,
...
impl AtipicialAccountState {
    /// Creates a new AtipicialAccountState
...
impl Default for AtipicialAccountState {
    fn default() -> Self {
        Self {
            balance: Int256::zero(),
            balance_height: 0,
...
/// Role types in the Atipicial network
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Role {
...
impl Role {
    ...
    pub fn from_byte(value: u8) -> Option<Self> {
        match value {
            ...
            8 => Some(Role::Oracle),
            16 => Some(Role::AtipicialFsAlphabet),
