...
use crate::serialize::{AtipicialSerializable, serialize_to_bytestring, deserialize_from_bytestring};
    ...
    pub fn put(&self, value: T) {
        match serialize_to_bytestring(&value) {
            ...
            Err(e) => {
                ...
                #[cfg(target_family = "wasm")]
                {
                    // In WASM/Atipicial VM context, we need to handle errors gracefully
...
where
    K: AtipicialSerializable,
    V: AtipicialSerializable,
{
    ...
    pub fn put(&self, key: K, value: V) {
        ...
        match serialize_to_bytestring(&value) {
            ...
            Err(e) => {
                ...
                #[cfg(target_family = "wasm")]
                {
                    // In WASM/Atipicial VM context, handle errors with proper logging
