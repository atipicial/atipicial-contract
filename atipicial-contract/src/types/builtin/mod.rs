...
impl<K: Primitive + primitive::Primitive + Ord + Clone, V: Clone> Builtin for Map<K, V> {}
impl<K: Primitive + primitive::Primitive + Ord + Clone, V: Clone> inner::Sealed for Map<K, V> {}
