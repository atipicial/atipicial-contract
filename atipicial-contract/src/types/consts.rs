...
pub enum WitnessScope {
    ...
    /// This can be the default safe choice for native ATC/GAS (previously used on Atipicial 2 as "attach" mode).
    CalledByEntry = 0x01,
    ...
    /// This allows the witness in all contexts (default Atipicial2 behavior).
    Global = 0x80,
}
