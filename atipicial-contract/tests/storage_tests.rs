...
//! Unit tests for atipicial-contract storage functionality.

#![cfg(test)]

use atipicial_contract::types::*;
mod mock_env;
use mock_env::{MockAtipicialEnvironment, storage::MockStorageMap};

#[test]
fn test_storage_map_put_get() {
    // Create mock environment and storage
    let mut env = MockAtipicialEnvironment::new();
