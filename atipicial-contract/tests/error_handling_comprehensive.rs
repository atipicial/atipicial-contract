...
//! and resilience of the Atipicial contract framework.
...
mod storage_error_tests {
    ...
    fn test_storage_map_error_handling() {
        use atipicial_contract::storage::StorageMap;
    ...
    fn test_storage_item_error_handling() {
        use atipicial_contract::storage::StorageItem;
...
mod runtime_error_tests {
    ...
    fn test_platform_info_consistency() {
        ...
        assert_eq!(platform1, ByteString::from_literal("ATC"));
        ...
        assert_eq!(network1, 860833102); // Atipicial mainnet
        
        let version1 = Runtime::get_address_version();
        let version2 = Runtime::get_address_version();
        assert_eq!(version1, version2);
        assert_eq!(version1, 53); // Atipicial address version
    }
}
...
mod crypto_error_tests {
    ...
    fn test_hash_function_edge_cases() {
        ...
        let empty_sha256 = atipicial_contract::crypto::sha256(empty_input.clone());
        let empty_ripemd = atipicial_contract::crypto::ripemd160(empty_input.clone());
        let empty_hash160 = atipicial_contract::crypto::hash160(empty_input.clone());
        let empty_hash256 = atipicial_contract::crypto::hash256(empty_input);
        ...
        let large_sha256 = atipicial_contract::crypto::sha256(large_input.clone());
        ...
        let binary_hash = atipicial_contract::crypto::sha256(binary_input);
        ...
        let hash1 = atipicial_contract::crypto::sha256(test_data.clone());
        let hash2 = atipicial_contract::crypto::sha256(test_data);
    ...
    fn test_signature_verification_edge_cases() {
        ...
        for &invalid_key in invalid_keys.iter() {
            ...
            let result = atipicial_contract::crypto::verify_ecdsa(
                test_message.clone(),
                pubkey,
                signature,
        ...
        let empty_msg_result = atipicial_contract::crypto::verify_ecdsa(
            empty_message,
            valid_pubkey.clone(),
        ...
        let curves = [
            atipicial_contract::crypto::NamedCurveHash::Secp256r1,
            atipicial_contract::crypto::NamedCurveHash::Secp256k1,
        ];
    ...
    fn test_multi_signature_edge_cases() {
        ...
        let empty_result = atipicial_contract::crypto::check_multi_signs(
            message.clone(),
            empty_keys,
            empty_sigs,
            0
        ...
        let mismatch_result = atipicial_contract::crypto::check_multi_signs(
            message.clone(),
            keys.clone(),
            sigs,
            2
        ...
        let high_threshold_result = atipicial_contract::crypto::check_multi_signs(
            message.clone(),
            keys.clone(),
            proper_sigs,
        ...
        let zero_threshold_result = atipicial_contract::crypto::check_multi_signs(
            message,
            keys,
            Array::new(),
            0
...
mod serialization_error_tests {
    use super::*;
    use atipicial_contract::serialization::StorageSerialize;
    ...
    fn test_storage_helpers_edge_cases() {
        ...
        for key in keys.iter() {
            ...
            atipicial_contract::serialization::storage_put(key.clone(), Int256::from(42));
            let int_retrieved = atipicial_contract::serialization::storage_get::<Int256>(key.clone());
            
            atipicial_contract::serialization::storage_put(key.clone(), true);
            let bool_retrieved = atipicial_contract::serialization::storage_get::<bool>(key.clone());
            
            atipicial_contract::serialization::storage_put(key.clone(), H160::zero());
            let h160_retrieved = atipicial_contract::serialization::storage_get::<H160>(key.clone());
...
use atipicial_contract::storage::{StorageItem, StorageMap};
