...
//! Unit tests for atipicial-contract serialization functionality.
...
fn test_byte_string_serialization() {
    let original = ByteString::from_literal("Hello, Atipicial!");
    ...
    let deserialized = ByteString::from_literal("Hello, Atipicial!");
