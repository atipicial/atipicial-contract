...
//! Comprehensive tests for the Atipicial Rust smart contract framework

#[cfg(test)]
mod serialization_tests {
    use atipicial_contract::prelude::*;
    use atipicial_contract::serialize::{serialize, deserialize};
...
mod enum_tests {
    use atipicial_contract::prelude::*;
    use atipicial_contract::types::VmState;
