...
//! Unit tests for atipicial-contract services.

#![cfg(test)]

use atipicial_contract::prelude::*;
use atipicial_contract::contract::native::{Gas, Atipicial, ContractManagement};
mod mock_env;
...
fn test_runtime_service() {
    ...
    assert_eq!(platform.to_bytes(), b"ATC");
...
fn test_native_contracts() {
    ...
    // Test ATC contract
    let atipicial_total_supply = Atipicial::total_supply();
    assert!(atipicial_total_supply > Int256::zero());
