//! Test utilities and helpers for Atipicial smart contract testing

#[cfg(test)]
pub mod test_utils {
    use atipicial_contract::prelude::*;
    use atipicial_contract::services::storage::Storage;
    use atipicial_contract::services::runtime::Runtime;
    ...
    impl DeploymentTestHelper {
        ...
        pub fn deploy_contract(aef_bytes: ByteString, manifest: ByteString) -> H160 {
        ...
        /// Update contract
        pub fn update_contract(aef_bytes: ByteString, manifest: ByteString) -> bool {
